...
public class UserServiceImpl implements UserService {
    ...
    public AuthUser save(AuthUser user) {
        valueOperations.put(user.getSource()+"_"+user.getUuid(), user);
        return user;
    }

    @Override
    public AuthUser getByUuidAndSource(String uuid,String source) {
        Object user = valueOperations.get(source+"_"+uuid);
        if(null == user) {
            return null;
        }
